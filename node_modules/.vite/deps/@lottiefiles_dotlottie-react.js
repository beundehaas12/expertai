...
var Z2 = class {
  ...
  dispatch(d) {
    var _a;
    (_a = this._eventListeners.get(d.type)) == null ? void 0 : _a.forEach((t) => t(d));
  }
...
var N = class {
  ...
  static observe(d, t) {
    var _a;
    this._initializeObserver(), !this._observedCanvases.has(d) && (this._observedCanvases.set(d, t), (_a = this._observer) == null ? void 0 : _a.observe(d));
  }
  static unobserve(d) {
    var _a, _b;
...
var G = class {
  ...
  static observe(d, t) {
    var _a;
    this._initializeObserver(), !this._observedCanvases.has(d) && (this._observedCanvases.set(d, [t, 0]), (_a = this._observer) == null ? void 0 : _a.observe(d));
  }
  static unobserve(d) {
    var _a;
...
var e3 = class L {
  ...
  get layout() {
    var _a;
    let t = (_a = this._dotLottieCore) == null ? void 0 : _a.config().layout;
  ...
  get manifest() {
    var _a;
    try {
      let t = (_a = this._dotLottieCore) == null ? void 0 : _a.manifestString();
  ...
  get segment() {
    var _a;
    let t = (_a = this._dotLottieCore) == null ? void 0 : _a.config().segment;
  ...
  get mode() {
    var _a, _b, _c, _d;
    let t = (_a = this._dotLottieCore) == null ? void 0 : _a.config().mode;
    return t === ((_b = L._wasmModule) == null ? void 0 : _b.Mode.Reverse) ? "reverse" : t === ((_c = L._wasmModule) == null ? void 0 : _c.Mode.Bounce) ? "bounce" : t === ((_d = L._wasmModule) == null ? void 0 : _d.Mode.ReverseBounce) ? "reverse-bounce" : "forward";
  }
  get isFrozen() {
  ...
  markers() {
    var _a;
    let t = (_a = this._dotLottieCore) == null ? void 0 : _a.markers();
    if (t) {
      let n = [];
  ...
  tween(t, n) {
    ...
    return ((_a = this._dotLottieCore) == null ? void 0 : _a.tween(t, n, _)) ?? false;
  }
  tweenToMarker(t, n) {
    var _a;
    if (!L._wasmModule) return false;
    let h = [0, 0, 1, 1], _ = new L._wasmModule.VectorFloat();
    for (let g of h) _.push_back(g);
    return ((_a = this._dotLottieCore) == null ? void 0 : _a.tweenToMarker(t, n, _)) ?? false;
  }
  animationSize() {
    var _a, _b;
    let t = ((_a = this._dotLottieCore) == null ? void 0 : _a.animationSize().get(0)) ?? 0, n = ((_b = this._dotLottieCore) == null ? void 0 : _b.animationSize().get(1)) ?? 0;
    return { width: t, height: n };
  }
  getLayerBoundingBox(t) {
    var _a;
    let n = (_a = this._dotLottieCore) == null ? void 0 : _a.getLayerBounds(t);
  ...
  static transformThemeToLottieSlots(t, n) {
    var _a;
    return ((_a = L._wasmModule) == null ? void 0 : _a.transformThemeToLottieSlots(t, n)) ?? "";
  }
  ...
  stateMachineStart() {
    ...
    if (this._stateMachineConfig) {
      ...
      if (h && typeof h.requireUserInteraction == "boolean" && (t.requireUserInteraction = h.requireUserInteraction), h == null ? void 0 : h.whitelist) {
  ...
  stateMachineOverrideState(t, n = false) {
    var _a;
    return ((_a = this._dotLottieCore) == null ? void 0 : _a.stateMachineOverrideCurrentState(t, n)) ?? false;
  }
  stateMachineGet(t) {
    var _a;
    return ((_a = this._dotLottieCore) == null ? void 0 : _a.getStateMachine(t)) ?? "";
  }
  ...
  stateMachineSetBooleanInput(t, n) {
    var _a;
    return ((_a = this._dotLottieCore) == null ? void 0 : _a.stateMachineSetBooleanInput(t, n)) ?? false;
  }
  stateMachineSetNumericInput(t, n) {
    var _a;
    return ((_a = this._dotLottieCore) == null ? void 0 : _a.stateMachineSetNumericInput(t, n)) ?? false;
  }
  stateMachineSetStringInput(t, n) {
    var _a;
    return ((_a = this._dotLottieCore) == null ? void 0 : _a.stateMachineSetStringInput(t, n)) ?? false;
  }
  stateMachineGetBooleanInput(t) {
    var _a;
    return (_a = this._dotLottieCore) == null ? void 0 : _a.stateMachineGetBooleanInput(t);
  }
  stateMachineGetNumericInput(t) {
    var _a;
    return (_a = this._dotLottieCore) == null ? void 0 : _a.stateMachineGetNumericInput(t);
  }
  stateMachineGetStringInput(t) {
    var _a;
    return (_a = this._dotLottieCore) == null ? void 0 : _a.stateMachineGetStringInput(t);
  }
  ...
  stateMachineFireEvent(t) {
    var _a;
    (_a = this._dotLottieCore) == null ? void 0 : _a.stateMachineFireEvent(t);
  }
  stateMachinePostClickEvent(t, n) {
    var _a;
    (_a = this._dotLottieCore) == null ? void 0 : _a.stateMachinePostClickEvent(t, n);
  }
  stateMachinePostPointerUpEvent(t, n) {
    var _a;
    (_a = this._dotLottieCore) == null ? void 0 : _a.stateMachinePostPointerUpEvent(t, n);
  }
  stateMachinePostPointerDownEvent(t, n) {
    var _a;
    (_a = this._dotLottieCore) == null ? void 0 : _a.stateMachinePostPointerDownEvent(t, n);
  }
  stateMachinePostPointerMoveEvent(t, n) {
    var _a;
    (_a = this._dotLottieCore) == null ? void 0 : _a.stateMachinePostPointerMoveEvent(t, n);
  }
  stateMachinePostPointerEnterEvent(t, n) {
    var _a;
    (_a = this._dotLottieCore) == null ? void 0 : _a.stateMachinePostPointerEnterEvent(t, n);
  }
  stateMachinePostPointerExitEvent(t, n) {
    var _a;
    (_a = this._dotLottieCore) == null ? void 0 : _a.stateMachinePostPointerExitEvent(t, n);
  }
  _onClick(t) {
    let n = z(t);
...
var g2 = class r1 {
  constructor(t) {
    ...
    let h = { ...t, renderConfig: { ...t.renderConfig, devicePixelRatio: ((_a = t.renderConfig) == null ? void 0 : _a.devicePixelRatio) || d1(), freezeOnOffscreen: ((_b = t.renderConfig) == null ? void 0 : _b.freezeOnOffscreen) ?? true } };
  ...
  async _create(t) {
    ...
    let { instanceId: h } = await this._sendMessage("create", { instanceId: this._id, config: { ...t, canvas: n }, ...Q2(this._canvas, ((_a = t.renderConfig) == null ? void 0 : _a.devicePixelRatio) || d1()) }, [n]);
...
var K1 = ({ animationId: d, autoplay: t, backgroundColor: n, className: h, createDotLottie: _, data: g, dotLottieRefCallback: l, layout: W, loop: V, mode: J, playOnHover: m1, renderConfig: c1, segment: D, speed: u1, src: q, stateMachineConfig: i1, stateMachineId: K, style: _1, themeData: f1, themeId: B, useFrameInterpolation: O, workerId: n1, ...Z }) => {
  ...
  let k1 = (0, import_react.useCallback)((x) => {
    var _a, _b;
    M.current = x, x ? w.current = _({ ...s1.current, canvas: x }) : ((_a = w.current) == null ? void 0 : _a.destroy(), w.current = null), (_b = g1.current) == null ? void 0 : _b.call(g1, w.current);
  }, []);
  return (0, import_react.useEffect)(() => {
    var _a, _b;
    let x = (y1) => {
      var _a2, _b2;
      m1 && (y1.type === "mouseenter" && ((_a2 = w.current) == null ? void 0 : _a2.play()), y1.type === "mouseleave" && ((_b2 = w.current) == null ? void 0 : _b2.pause()));
    };
    return (_a = M.current) == null ? void 0 : _a.addEventListener("mouseenter", x), (_b = M.current) == null ? void 0 : _b.addEventListener("mouseleave", x), () => {
      var _a2, _b2;
      (_a2 = M.current) == null ? void 0 : _a2.removeEventListener("mouseenter", x), (_b2 = M.current) == null ? void 0 : _b2.removeEventListener("mouseleave", x);
    };
  }, [m1]), (0, import_react.useEffect)(() => {
    var _a;
    (_a = w.current) == null ? void 0 : _a.setSpeed(u1 ?? 1);
  }, [u1]), (0, import_react.useEffect)(() => {
    var _a;
    (_a = w.current) == null ? void 0 : _a.setMode(J ?? "forward");
  }, [J]), (0, import_react.useEffect)(() => {
    var _a;
    (_a = w.current) == null ? void 0 : _a.setLoop(V ?? false);
  }, [V]), (0, import_react.useEffect)(() => {
    var _a;
    (_a = w.current) == null ? void 0 : _a.setUseFrameInterpolation(O ?? true);
  }, [O]), (0, import_react.useEffect)(() => {
    var _a;
    typeof (D == null ? void 0 : D[0]) == "number" && typeof D[1] == "number" && ((_a = w.current) == null ? void 0 : _a.setSegment(D[0], D[1]));
  }, [D]), (0, import_react.useEffect)(() => {
    var _a;
    (_a = w.current) == null ? void 0 : _a.setBackgroundColor(n ?? "");
  }, [n]), (0, import_react.useEffect)(() => {
    var _a;
    (_a = w.current) == null ? void 0 : _a.setRenderConfig(c1 ?? {});
  }, [JSON.stringify(c1)]), (0, import_react.useEffect)(() => {
    var _a;
    typeof g != "string" && typeof g != "object" || ((_a = w.current) == null ? void 0 : _a.load({ data: g, ...s1.current }));
  }, [g]), (0, import_react.useEffect)(() => {
    var _a;
    typeof q == "string" && ((_a = w.current) == null ? void 0 : _a.load({ src: q, ...s1.current }));
  }, [q]), (0, import_react.useEffect)(() => {
    var _a;
    (_a = w.current) == null ? void 0 : _a.setMarker(Z.marker ?? "");
  }, [Z.marker]), (0, import_react.useEffect)(() => {
    var _a;
    (_a = w.current) == null ? void 0 : _a.loadAnimation(d ?? "");
  }, [d]), (0, import_react.useEffect)(() => {
    var _a;
    typeof B == "string" && ((_a = w.current) == null ? void 0 : _a.setTheme(B));
  }, [B]), (0, import_react.useEffect)(() => {
    var _a;
    (_a = w.current) == null ? void 0 : _a.setThemeData(f1 ?? "");
  }, [f1]), (0, import_react.useEffect)(() => {
    var _a;
    (_a = w.current) == null ? void 0 : _a.setLayout(W ?? {});
  }, [W == null ? void 0 : W.fit, (W == null ? void 0 : W.align) && W.align[0], (W == null ? void 0 : W.align) && W.align[1]]), (0, import_react.useEffect)(() => {
    var _a;
    ((_a = w.current) == null ? void 0 : _a.isLoaded) && (typeof K == "string" && K ? w.current.stateMachineLoad(K) && w.current.stateMachineStart() : w.current.stateMachineStop());
  }, [K]), (0, import_react.useEffect)(() => {
    var _a;
    (_a = w.current) == null ? void 0 : _a.stateMachineSetConfig(i1 ?? null);
